...
<body>
        ...
        <div class="row gx-0 align-items-center">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    ...
                    <small>+212 06 00 00 00 00</small>
                </div>
                <div class="h-100 d-inline-flex align-items-center me-4">
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5" style="top: -100px;">
        <a href="index.html" class="navbar-brand d-flex align-items-center">
            <h1 class="m-0"><img class="img-fluid me-3" src="img/icon/logo_1.jpg" alt="">Easy insure</h1>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto bg-light rounded pe-4 py-3 py-lg-0">
                <a href="Easy_insure.html" class="nav-item nav-link active">Acceuil</a>
                <a href="À propos de nous.html" class="nav-item nav-link">À propos de nous</a>
                <a href="Nos_produits_2.html" class="nav-item nav-link">Nos produits</a>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-12 col-lg-6">
                                    <h1 class="display-3 text-dark mb-4  slideInDown">Nous prenons <br> à cœur <br> nos assurés</h1>
                                    <p class="fs-5 text-body mb-5">Vous avez eu un abus faiblesse ? <br>appuyez le bouton bleue rapidement <br> et nous serons heureux de vous aider</p>
                                    <a href="" class="btn btn-primary py-3 px-5">Contactez-nous</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
                    <div class="h-100">
                        <h1 class="display-6 mb-5">A propos de nous - notre expérience</h1>
                        <p class="fs-5 text-primary mb-4"></p>
                        <div class="row g-4 mb-4">
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <img class="flex-shrink-0 me-3" src="img/icon/icon-04-primary.png" alt="">
                                    <h5 class="mb-0">Près de vous</h5>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="d-flex align-items-center">
                                    <img class="flex-shrink-0 me-3" src="img/icon/icon-03-primary.png" alt="">
                                    <h5 class="mb-0">Sécurisez votre argent</h5>
                                </div>
                            </div>
                        </div>
                        <p class="mb-4">
                            L'équipe juridique de "Le Cœur des Assureurs" est hautement 
                            qualifiée et possède une vaste expérience dans le domaine 
                            des litiges liés aux contrats signés sans consentement. Nous travaillons
                             en étroite collaboration avec nos clients pour examiner leurs cas, analyser les 
                             documents pertinents et élaborer des stratégies juridiques efficaces.</p>
    ...
    <div class="container-fluid overflow-hidden my-5 px-lg-0">
        <div class="container facts px-lg-0">
            <div class="row g-0 mx-lg-0">
                <div class="col-lg-6 facts-text wow fadeIn" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                    <div class="h-100 px-4 ps-lg-0">
                        <h1 class="text-white mb-4">Pour les particuliers et les organisations</h1>
                        <p class="text-light mb-5">L'expérience de travail accumulée au fil des années peut contribuer au développement professionnel d'une personne. Elle permet d'acquérir de nouvelles compétences, d'approfondir les compétences existantes et de gagner en expertise.</p>
                        <a href="" class="align-self-start btn btn-secondary py-3 px-5">Plus de Détails</a>
                    </div>
                </div>
                <div class="col-lg-6 facts-counter wow fadeIn" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;">
                    <div class="h-100 px-4 pe-lg-0">
                        <div class="row g-5">
                            <div class="col-sm-6">
                                <h1 class="display-5" data-toggle="counter-up">12000</h1>
                                <p class="fs-5 text-primary">Clients satisfaits</p>
                            </div>
                            <div class="col-sm-6">
                                <h1 class="display-5" data-toggle="counter-up">36000</h1>
                                <p class="fs-5 text-primary">Demande</p>
                            </div>
                            <div class="col-sm-6">
                                <h1 class="display-5" data-toggle="counter-up">98</h1>
                                <p class="fs-5 text-primary">Taux de réussite </p>
                            </div>
                            <div class="col-sm-6">
                                <h1 class="display-5" data-toggle="counter-up">90</h1>
                                <p class="fs-5 text-primary">Equipe professionelle</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    ...
                    <p class="mb-4">protection financière ; sécurité familiale ; couverture spécifique ; accés a des soins</p>
                    <div class="row g-3">
                        ...
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
                            <div class="bg-light rounded h-100 p-3">
                                <div class="bg-white d-flex flex-column justify-content-center text-center rounded py-4 px-3">
                                    ...
                                    <h5 class="mb-0">Contrôle de politiques</h5>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 wow fadeIn" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
                            <div class="bg-light rounded h-100 p-3">
                                <div class="bg-white d-flex flex-column justify-content-center text-center rounded h-100 py-4 px-3">
                                    ...
                                    <h5 class="mb-0">Économie d'argent</h5>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto" style="max-width: 500px;">
                <h1 class="display-6 mb-5">Nous fournissons des services d'assurance professionnels</h1>
            </div>
            <div class="row g-4 justify-content-center">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div class="service-item rounded h-100 p-5">
                        ...
                        <p class="mb-4">Il existe généralement deux types principaux d'assurance vie : l'assurance temporaire (ou terme) et l'assurance vie entière (ou permanente).</p>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                    <div class="service-item rounded h-100 p-5">
                        ...
                        <p class="mb-4">Elle offre une protection financière en cas de frais médicaux ou de soins de santé. Ces services peuvent varier en termes de couverture, de coûts et de types de soins inclus, mais l'objectif principal est de garantir que les individus ont accès à des soins de santé abordables en cas de maladie ou de blessure.</p>
                        <a class="btn btn-light px-3" href="">En savoir plus</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
                    <div class="service-item rounded h-100 p-5">
                        ...
                        <p class="mb-4">Elle protége votre domicile et vos biens personnels en cas de dommages, de vol, de catastrophes naturelles, ou d'autres événements imprévus.</p>
                        <a class="btn btn-light px-3" href="">En savoir plus</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeInUp;">
                    <div class="service-item rounded h-100 p-5">
                        ...
                        <p class="mb-4">Elle couvre les coûts liés à la possession et à l'utilisation d'un véhicule automobile. Ces services sont essentiels pour protéger les conducteurs, les passagers et les biens en cas d'accidents ou de dommages.</p>
                        <a class="btn btn-light px-3" href="">En savoir plus</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">
                    <div class="service-item rounded h-100 p-5">
                        <div class="d-flex align-items-center ms-n5 mb-4">
                            ...
                            <h4 class="mb-0">Protection juridique</h4>
                        </div>
                        <p class="mb-4">Elle offre une assistance et une couverture financière en cas de litige juridique ou de besoin de conseils juridiques. Il est conçu pour aider les individus
                             ou les entreprises à faire face aux coûts élevés associés à des procédures juridiques ou à des litiges.</p>
                        <a class="btn btn-light px-3" href="">En savoir plus</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;">
                    <div class="service-item rounded h-100 p-5">
                        <div class="d-flex align-items-center ms-n5 mb-4">
                            ...
                            <h4 class="mb-0">َAssurance Entreprise</h4>
                        </div>
                        <p class="mb-4">fait référence à un ensemble de processus et de pratiques utilisés par les entreprises pour garantir la fiabilité, 
                            la disponibilité et la qualité de leurs services informatiques et de télécommunication.</p>
                        <a class="btn btn-light px-3" href="">En savoir plus</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
                    <h1 class="display-6 text-white mb-5">Contactez-nous</h1>
                    <p class="text-white mb-5">Nous sommes toujours à votre disposition.</p>
                    <div class="bg-white rounded p-3">
                        <div class="d-flex align-items-center bg-primary rounded p-3">
                            <img class="flex-shrink-0 rounded-circle me-3" src="img/profile.jpg" alt="">
                            <h5 class="text-white mb-0">Contacter ce numéro: (+212) 06 00 00 00 00 00 </h5>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-floating">
                                        ...
                                        <label for="cname">Votre Numéro Téléphone</label>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="cage" placeholder="Child Age">
                                        <label for="cage"> Sujet </label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h1 class="text-white mb-4"><img class="img-fluid me-3" src="img/icon/" alt="">Easy insure</h1>
                    <p></p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p><i class="fa fa-map-marker-alt me-3"></i>MAROC</p>
                    <p><i class="fa fa-phone-alt me-3"></i>06 000 000 0</p>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        © 2023 Copyrights par <a href="#"> Easy insure.</a> Tous les droits sont réservés
                    </div>
                    </div>
                </div>
            </div>
